...
def LDA():
    train = []  # 训练数据
    fp = codecs.open(r'F:\github\WBFL\uploadpath\output\output.txt', 'r', encoding='utf-8')
    for line in fp:
        line = line.split()
    ...
    with open(r'F:\github\WBFL\uploadpath\output\wordlistOutput.txt', 'w', encoding='utf-8') as f1:
    ...
    inputs = open(r'F:\github\WBFL\uploadpath\input\input.txt', 'r', encoding='utf-8')
    ...
    with open(r'F:\github\WBFL\uploadpath\output\finaloutput.txt', 'w', encoding='utf-8') as f:
